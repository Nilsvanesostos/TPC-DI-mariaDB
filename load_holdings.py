...
SELECT HH_H_T_ID AS TradeId, HH_T_ID AS CurrentTradeID, DT.SK_CustomerID, DT.SK_AccountID, DT.SK_SecurityID, DT.SK_CompanyID, DT.SK_CloseDateID AS SK_DateID, DT.SK_CloseTimeID AS SK_TimeID, DT.TradePrice AS CurrentPrice, HH_AFTER_QTY AS CurrentHolding, {batch_number} AS BatchID
FROM S_Holdings H
