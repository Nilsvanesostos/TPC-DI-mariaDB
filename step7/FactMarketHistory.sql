CREATE INDEX IF NOT EXISTS idx_DM_DATE ON S_Daily_Market (DM_DATE);
CREATE INDEX IF NOT EXISTS idx_DM_S_SYMB ON S_Daily_Market (DM_S_SYMB);
CREATE INDEX IF NOT EXISTS idx_DateValue ON DimDate (DateValue);
CREATE INDEX IF NOT EXISTS idx_Symbol ON DimSecurity (Symbol);
CREATE INDEX IF NOT EXISTS idx_SK_CompanyID ON Financial (SK_CompanyID);
